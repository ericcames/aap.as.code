...
6. Fork the following repo<br>https://github.com/ericcames/event.driven.ansible
Update the servicenow [rulebook](https://github.com/ericcames/event.driven.ansible/blob/main/rulebooks/servicenow/servicenow_events.yml "servicenow_events.yml") with the short description of your catalog item.<br>
